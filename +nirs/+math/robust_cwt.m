...
if any(numvoices) && isscalar(numvoices)
...
% Override the Y tick labels once, then add callbacks 
for ii = 1:numel(AX)
    ...
    AX(ii).YAxis.LimitsChangedFcn = @changeYTickLabels;
end
...
if ~antiAnalytic
    ...
    if datetimeLabelFlag
        datetick('x','KeepLimits'); %#ok<*DATIC>
    end    
