...
%    See also PLOT.
        ...
        function [beta,CovB,stats]=stats(this)
            CovB=this.Cov;
            beta=this.B;
            ...
            stats.dfe=this.DFE-length(beta);
...
%   based on the contrast matrix C. The default value of C is the Q factor
%   in a QR decomposition of M, where M is defined so that Y*M is the
...
%    See also MARGMEAN.
    ...
    methods(Static, Hidden)
        function this = fit(ds,model,Noise,pmax,varargin) % fit method to be called by fitrm
...
%   See also FITRM.
            ...
            % valid.
            this = nirs.math.RepeatedMeasuresModel();
