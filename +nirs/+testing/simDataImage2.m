function [data, truth, fwdModel, truthchan, nulldata] = simDataImage2(fwdModel, noise, stim, beta, basis )
...
%     [data, truth] = simData( noise, stim, beta, channels )
    ...
    if(nargin<1 || isempty(fwdModel))
        ...
        fwdModel.mesh=fwdBEM.mesh(end);
        fwdModel.prop=fwdBEM.prop{end};
