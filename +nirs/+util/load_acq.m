...
%
function [acq,d] = load_acq(filename, chan_by_chan)
   ...
   for idx=1:length(acq.hdr.per_chan_data)
       d(idx).data=acq.data(:,idx);
       d(idx).name=acq.hdr.per_chan_data(idx).comment_text;
   end
