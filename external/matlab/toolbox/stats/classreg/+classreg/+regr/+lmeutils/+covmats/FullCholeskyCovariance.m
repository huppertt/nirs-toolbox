...
%FullCholeskyCovariance - Class to represent a 'FullCholesky' covariance matrix using the Cholesky parameterization.
...
%
%   When PSI is of Type 'FullCholesky', all elements of PSI are different
%   (except for symmetry). Here's an example to illustrate what the
...
%   In other words,
%
%           theta = [L_11;L_21;L_31;L_22;L_32;L_33] 
%
...
%
%   FullCholeskyCovariance methods:
%       FullCholeskyCovariance - Create a 'FullCholesky' covariance matrix.
...
%
%   FullCholeskyCovariance properties:
...
%FullCholeskyCovariance - Construct a FullCholeskyCovariance object.
%   OBJ = FullCholeskyCovariance(DIMENSION) takes an integer DIMENSION and 
%   constructs a FullCholeskyCovariance object.
%
%   OBJ = FullCholeskyCovariance(DIMENSION,'VariableNames',VNAMES) also
%   specifies the variable names associated with rows and columns of this
%   covariance matrix.
%
%   OBJ = FullCholeskyCovariance(DIMENSION,'VariableNames',VNAMES,'Name',NAME) 
%   also specifies the name to be associated with this covariance matrix.
        ...
        end % end of FullCholeskyCovariance
...
%   unconstrained, natural and canonical for accuracy.
    ...
    methods (Access=public, Hidden=true)
        ...
        % A 'FullCholesky' covariance has type 'FullCholesky'.
        ...
        % A 'FullCholesky' covariance does not set any element to 0. So the 
