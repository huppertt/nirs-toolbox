...
%DiagonalCovariance Class to represent a 'Diagonal' covariance matrix.
...
%
%   When PSI is of Type 'Diagonal', only the diagonal elements of PSI are
%   non-zero, all other elements are zero. Here's an example to illustrate 
...
%                 0     0    D_33]
%
%   The positive definiteness of D requires that D_ii >= 0. An
%   unconstrained parameterization of D that guarantees positive
%   definiteness is given by:
%
%           theta = [log(D_11);log(D_22);log(D_33)] 
%
...
%   elements of StdCorr.
%
%   DiagonalCovariance methods:
%       DiagonalCovariance - Create a 'Diagonal' covariance matrix.
...
%DiagonalCovariance - Construct a DiagonalCovariance object.
%   OBJ = DiagonalCovariance(DIMENSION) takes an integer DIMENSION and 
%   constructs a DiagonalCovariance object.
%
%   OBJ = DiagonalCovariance(DIMENSION,'VariableNames',VNAMES) also 
%   specifies the variable names associated with rows and columns of this 
%   covariance matrix.
%
%   OBJ = DiagonalCovariance(DIMENSION,'VariableNames',VNAMES,'Name',NAME) 
...
%   unconstrained, natural and canonical for accuracy.
    ...
    methods (Access=public, Hidden=true)
        ...
        function L = theta2L(this,theta) %#ok<INUSL>
            ...
            %L = spdiags(sqrt(exp(theta)),0,this.Size,this.Size);
        end % end of theta2L.
...
%   elements of StdCorr.
        ...
        % A 'Diagonal' covariance has type 'Diagonal'.
        ...
        % A 'Diagonal' covariance sets the off diagonal elements to be 
        % equal to 0.         
