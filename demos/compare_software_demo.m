...
num_iter = 10;  % In the paper, I ran 1000, but this took over a day to run on 
...
legend({'OLS (HOMER)',...
    'AR-IRLS',...
    'DCT128/none/AR(1) (NIRS-SPM)',...
    'Wavelet/none/AR(1) (NIRS-SPM)',...
    'DCT128/hrf/none (NIRS-SPM)',...
    'DCT128/none/none (NIRS-SPM)'});
...
legend({'OLS (HOMER)',...
    ...
    'Wavelet/none/AR(1) (NIRS-SPM)',...
    'DCT128/hrf/none (NIRS-SPM)',...
    'DCT128/none/none (NIRS-SPM)','ideal'});
